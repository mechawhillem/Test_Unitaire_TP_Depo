...
class TestCalculMethods(unittest.TestCase):
    ...
    def test_check_out_book(self):
        library = Library()
        self.assertEqual(library.check_out_book(None), None)

    def test_check_in_book(self):
        library = Library()
        self.assertEqual(library.check_in_book(None), None)

    def test_check_out_book_client(self):
        client = Client("Test")
        self.assertEqual(client.check_out_book(Library(),None), None)
    
    def test_check_in_book_client(self):
        client = Client("Test")
        self.assertEqual(client.check_in_book(Library(),None), None)
